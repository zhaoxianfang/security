...
return [
    ...
    'path' => [
        ...
        ['pattern' => '/(?<!\w)(\.env|\.git\/)/i', 'desc' => '.env配置文件或.git目录访问', 'risk' => 'medium'],
        ['pattern' => '/(?<!\w)(\.svn|\.hg|\.bzr)/i', 'desc' => '版本控制目录泄露（.svn/.hg/.bzr）', 'risk' => 'medium'],
        ['pattern' => '/(?<!\w)(\.htaccess|\.htpasswd|web\.config)/i', 'desc' => 'Web服务器配置文件访问', 'risk' => 'medium'],
